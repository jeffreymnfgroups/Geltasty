  ...
  return (
    <>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-auto my-10 h-fit max-w-md rounded-3xl bg-white overflow-hidden shadow-2xl dark:bg-neutral-900"
            >
              <button
                className="absolute top-4 right-4 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-black/80 backdrop-blur-sm dark:bg-white/80"
                onClick={handleClose}
              >
              ...
              <div className="relative h-32 w-full overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <motion.p
                    ...
                    className="mt-1 text-xl font-semibold text-white drop-shadow-lg"
                  >
                    {card.title}
                  </motion.p>
                </div>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-75 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900 cursor-pointer hover:scale-105 transition-transform duration-200 ease-out"
        whileHover={{ y: -5 }}
        whileTap={{ scale: 0.98 }}
        drag
      ...
      >
        ...
        <div className="relative z-40 p-8 bg-gradient-to-b from-black/20 to-transparent rounded-b-3xl">
          <motion.p
